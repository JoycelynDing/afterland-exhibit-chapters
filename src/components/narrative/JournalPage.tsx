...
export const JournalPage = ({
  ...
  useEffect(() => {
    ...
    const shouldWaitForManualPageTurn = pendingItem.type !== "image" && pendingPageIndex > currentPageIndex;

    if (pendingPageIndex !== currentPageIndex && !shouldWaitForManualPageTurn) {
